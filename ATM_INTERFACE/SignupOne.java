...
public class SignupOne extends JFrame implements ActionListener{
   ...
   // long random;
    ...
    long random= (Math.abs(ran.nextLong()% 9000L + 1000L));  //gives a 4 digit number
    ...
    SignupOne(){
        ...
        formno.setBounds(140, 20, 600, 40);   //works only when setLayout() is set to null
        add(formno);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{
            if(name.equals("")){
                ...
                c.s.executeUpdate(query); //query runs in mysql
